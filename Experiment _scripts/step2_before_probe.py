"""
Step 2: BEFORE probe — all three question types, no positional knowledge.
"""
...
CONTEXT = (
    ...
    f"You don't know their positions yet, but answer as best you can.\n\n"
)
...
with open("RL_Exp1_Time1.json", "w") as f:
    json.dump(results, f, indent=2)

print("\nSaved RL_Exp1_Time1.json")
